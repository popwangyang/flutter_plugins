...
@property (nonatomic, assign) BOOL isFullTraceUploadEnabled;        // 是否支持full-trace随crash上传，SDK初始化的时候就解析配置，防止崩了之后再处理增加失败率
